...
const Intro = () => (
	<InitialContainer background={theme.colors.colorBrand2}>
		<PageIntro
			...
			paragraph="Want to know more about your potential startup team members?
				Learn more about what we have to offer and our core values to achieve our shared mission."
			image={
				(
		...
		<Container>
			<CompetencesContainer>
				...
				<IconBlocksContainer>
					<IconTextBlock
						title="Transparent"
						text="Transparency is one of the core components of a successful working relationship.
						We tell you what you can expect from us, and what we want from you.
						We will give our honest opinion on your startup idea and give tips to improve."
						icon={Eye}
					/>
					<IconTextBlock
						icon={Book}
						title="Knowledgeable"
						text="With our guidance, you can avoid or overcome common pitfalls
							that we have seen many startup founders get trapped in.
							We love to share our knowledge through strategic sessions and online webinars."
					/>
					<IconTextBlock
						icon={PeopleArrows}
						title="Personal"
						text="We tailor the startup experience and knowledge we have to your idea and product.
							Every startup and founder is different.
							Our team will complement yours and fulfill the role of a tech co-founder and CTO."
					/>
					<IconTextBlock
						icon={Arrows}
						title="Versatile"
						text="Apart from “just” developing your product idea into a working and amazing product,
							we support you throughout the whole process: strategizing, defining, designing, and only then developing.
...
const summationText: SummationText[] = [
	...
	{
		title: "Do and learn.",
		text: "We believe that skills come with experience. We are not afraid to make mistakes and learn from them. " +
			"Sometimes we figure out ways to do things better and faster. We don't get stuck in the old, we innovate."
	},
	{
		title: "High in energy!",
		text: "We love to work with founders that are passionate about their idea. " +
			"Enthusiasm is contagious, so if you are willing to change the world, then so are we!"
	}
];
