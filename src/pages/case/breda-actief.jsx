            ...
            <Row align="center">
                <Col lg={6}>
                    <Checklist>
                        ...
                        <CheckListItem>
                            Voor het juridische deel van de website hebben we
                            een multisite opgezet, met als positieve
                            consequentie dat de styling van beide sites zonder
                            dubbel werk aangepast kan worden
                        </CheckListItem>
                    </Checklist>
                </Col>
                <Col lg={6}>
