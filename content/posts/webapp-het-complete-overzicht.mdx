...
summary: 'Webapp: wat is een (progressive) webapp? Is een webapp beter dan een mobiele app en wat is de waarde van een webapp voor jouw bedrijf? Lees het hier!'
...
*   [Wat is een webapp en hoe werkt het?](#Wat-is-een-webapp-en-hoe-werkt-het)
*   [Wat is een progressive webapp?](#Wat-is-een-progressive-webapp)
*   [Webapp versus native app: wat zijn de voor- en nadelen?](#Webapp-vs-native-app-wat-zijn-de-voor-en-nadelen)
*   [Wat heb ik aan een webapp?](#Wat-heb-ik-aan-een-webapp)
...
<small>[Bron checklist: Google](https://developers.google.com/web/progressive-web-apps/checklist)</small>
