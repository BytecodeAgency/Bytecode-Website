        ...
        <article>
                ...
                <Row>
                    <Col offset={{ md: 1, lg: 1, xl: 3 }} md={10} lg={8} xl={5}>
                        ...
                        <ul>
                                ...
                                <br />
                                <p>
                                    Voordat we starten met ontwikkelen, maken we
                                    eerst een gedetailleerde analyse. Dit stelt
                                    ons in staat om een helder en volledig
                                    overzicht te krijgen van de huidige
                                    situatie. Hierdoor kunnen wij de pijnpunten
                                    in beeld brengen en analyseren welke punten
                                    het meeste prioriteit hebben. Voordat we
                                    starten met ontwikkelen, maken we eerst een
                                    gedetailleerde analyse. Dit stelt ons in
                                    staat om een helder en volledig overzicht te
                                    krijgen van de huidige situatie. Hierdoor
                                    kunnen wij de pijnpunten in beeld brengen en
                                    analyseren welke punten het meeste
                                    prioriteit hebben.
                                </p>
                ...
                <Row>
                    <Col
                        ...
                        <figure>
                            <img
                                src="/static/img/content/interior.png"
                                alt="test image"
                            />
                ...
                <Row>
                    <Col offset={{ md: 1, lg: 2, xl: 3 }} md={10} lg={8} xl={5}>
                        ...
                        <p className="call-to-action">
                            Dit artikel is geschreven het team van Bytecode. Een
                            klein maar fijne web agency in Rotterdam. Net als in
                            deze artikelen willen wij jou in ons werk graag
                            nieuwe inzichten geven hoe je het internet kan
                            gebruiken. Heb je vragen over dit artikel of wil je
                            meer over ons weten?
                            <a href="/contact">
                                {' '}
