...
const content = {
    ...
    html_content: `
        ...
        <p>Veel internetbureaus spelen in op de ondernemers met een klein(er) budget. Om daarop in te spelen adverteren ze met slogans zoals: "complete website voor 549 euro!", of "website laten maken voor 600 euro." Daarnaast beloven ze snelle levertijden, zodat je rap met je investering aan de slag kan.</p>
        <p>Je kan een website laten maken door bureaus die zulke websites als eindproduct leveren, maar het probleem met dit soort websites is dat het vaak gestandaardiseerde WordPress thema’s zijn. Maar wWaarom zou je eigenlijk geen gestandariseerde website laten maken door een webdeveloper?</p>
        ...
        <li>
        <strong>Uniek zijn</strong>, dus geen gestandaardiseerde thema’s maar een website die volledig ontworpen is om jouw doelgroep te dienen.</li>
        <li>
        <strong>Conversie geoptimaliseerd</strong> ingericht zijn</li>
        <li>
        <strong>Zoek-geoptimaliseerd zijn</strong>, je wil immers dat jouw website ook gevonden wordt!</li>
        ...
        <ol>
        <li>Analyseren: voordat ze ontwikkelen maken ze een gedetailleerde analyse. Hiermee kunnen ze een goed beeld creëren van de huidige en gewenste situatie. Dit doen ze door een goed marktonderzoek te doen zodat ze kunnen achterhalen wat echt bij jouw doelgroep aansluit. Belangrijk hierbij is het type doel van de website. Denk hierbij aan de vijf verschillende modellen van websites. Daardoor kunnen ze een product leveren dat precies aan je wensen voldoet.</li>
        ...
        <li>Realiseren: pas na dat alles geanalyseerd en gepland is, gaat het bedrijf aan de slag met de uitvoering van jouw website. Na het realiseren ben je nog niet klaar, want een bedrijf dat wil inspelen op veranderingen die zich voordoen in de markt zal ook moeten blijven veranderen!</li>
        </ol>
        <h2>Conclusie</h2>
